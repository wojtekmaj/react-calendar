...
var DecadeView = function (_Component) {
  (0, _inherits3.default)(DecadeView, _Component);

  function DecadeView() {
    (0, _classCallCheck3.default)(this, DecadeView);
    return (0, _possibleConstructorReturn3.default)(this, (DecadeView.__proto__ || (0, _getPrototypeOf2.default)(DecadeView)).apply(this, arguments));
  }

  (0, _createClass3.default)(DecadeView, [{
