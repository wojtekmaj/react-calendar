...
import { getBeginOfWeek, getWeekNumber } from '../shared/dates.js';
...
export default function WeekViewWeekNumbers(props: WeekNumbersProps): React.ReactElement {
  const { activeStartDate, calendarType, onClickWeekNumber, onMouseLeave } =
    props;
