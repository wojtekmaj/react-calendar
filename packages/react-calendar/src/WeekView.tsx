...
import Days from './WeekView/Days.js';
import Weekdays from './WeekView/Weekdays.js';
import WeekNumbers from './WeekView/WeekNumbers.js';
...
type WeekViewProps = {
  ...
  /**
   *  Whether week numbers shall be shown at the left of WeekView or not.
   *
   * @default false
   * @example true
   */
 ...
 */
export default function WeekView(props: WeekViewProps): React.ReactElement {
  ...
  const className = 'react-week-view';
